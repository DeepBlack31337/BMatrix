...
////////////Закомментировал и оставил самый простой вариант.
...
namespace ConsoleApp1
{
    class CalcArr
    {
        ...
        public static int[,] FileBi(String Filename)
        {
            ...
            foreach (var sttr in FileX)
            {
                ...
                try
                {
                    ...
                    ordArr[IndStr, IndCol] = ordArr[IndStr, IndCol] + Papers;
                    ordArr[IndStr, 4] = ordArr[IndStr, 4] + Dollars;
        ...
        //            for (i = 4; i < mstep+8; i += System.Numerics.Vector<int>.Count + 4)
        //            {
        //                //////Заполняем первые 8
